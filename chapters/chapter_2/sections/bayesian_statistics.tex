...
In this section, I introduce some key concepts of Bayesian statistics to be used in the remainder of the thesis.  I begin with explaining how Bayesianism differs from Frequentism in philosophy.  I then introduce Bayes Nets as a tool for visualizing the factorization of joint distirbutions.  Finally, I discuss some finer points of Bayesian modelling, such as model diagnostics and MCMC computation.


\subsection{Bayesians v. Frequentists}

In Frequentism, probability is understood as the long term relative frequency of an event occurring.  Consequently, Statisticians assess estimators by considering the estimator's frequency properties (i.e. the behaviour of the estimator under repeated construction).  Frequentistism is strongly contrasted against Bayesianism, where probability represents a strength in a belief \cite{gelman2013bayesian}.
