...
\newcommand{\titl}{Bayesian Pharmacokinetic Models for Inference and Optimal Sequential Decision Making For Applications in Personalized Medicine}
\newcommand{\spinetitle}{Bayesian PK Models for Inference and Decsision Making in Personalized Medicine}%only if the above is more than 60 characters
...
Thank you to Dan.  Dan, I'm not sure what I have done to deserve the kindness, patience, and care you have shown me.  You are an excellent supervisor, ideal mentor, and all around good human.  I am incredibly lucky to have landed you as a supervisor. Words can not convey how much yout guidance has meant, so please accept this humble ``thank you'' anyway.

Thank you to Gary.  Gary, graduate school was never easy for either of us.  How many times had we sat over coffee and listed out all the reasons we should leave?  How many times have we also entered heated debates on statistics and epidemiology? How many times have we entered passionate discussion on medical research as it is done today?  Gary, you are by now across the country living a new life.  I miss you dearly, and want you to that this success is as much yours as it is mine.  Thank you for being a good friend.
 
Thank you to Simon.  Simon, I owe all statistical success I have ahcieved and will go on to achieve to you.  You have shaped me into the statsitician I am today, and I hope you can wear that accolade with pride.  You are an amazing instructor, and I am proud to have called you a mentor. Thank you.
}
...
\addcontentsline{toc}{chapter}{\dfrac{Abstract}{den}}
